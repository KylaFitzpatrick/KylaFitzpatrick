...
const Manifesto = () => (
    <section id="manifesto" className="relative py-24 sm:py-36 bg-[#0A0F1D]/40 border-y border-white/[0.05]">
                ...
                {CHAPTERS.map((c, i) => (
                    ...
                    >
                        <div className="sm:col-span-3">
                            <span className="font-display font-extrabold text-6xl sm:text-7xl leading-none text-transparent [-webkit-text-stroke:1px_rgba(96,165,250,0.35)] transition-all duration-500 group-hover:[-webkit-text-stroke:1px_rgba(96,165,250,0.8)]">
                                {c.n}
                            </span>
                        </div>
