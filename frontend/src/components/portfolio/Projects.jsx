            ...
            <AnimatePresence>
                {preview && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-[70] bg-[#060B08]/85 backdrop-blur-md flex items-center justify-center p-4 sm:p-8"
                    >
                        <motion.div
                            ...
                            className="w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl border border-white/10 bg-[#0A110D] shadow-[0_0_80px_rgba(5,150,105,0.15)]"
                        >
                            <div className="flex items-center justify-between px-5 sm:px-7 py-4 border-b border-white/[0.07]">
                                ...
                                <button
                                    ...
                                    onClick={() => setPreview(null)}
                                    className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-emerald-500/50 transition-colors duration-300"
                            ...
                            <div className="px-5 sm:px-7 py-6">
                                ...
                                <a
                                    ...
                                    className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-500 rounded-full px-6 py-3 transition-colors duration-300"
                                >
