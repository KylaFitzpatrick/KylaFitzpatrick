        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-16 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
            ...
            <div className="flex">
                <a
                    ...
                    className="group flex items-center gap-2.5 font-mono-jb text-[11px] uppercase tracking-[0.2em] text-slate-500 hover:text-emerald-400 transition-colors duration-300"
                >
                    <Github size={14} />
                    Source on GitHub
                </a>
